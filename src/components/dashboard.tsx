                        ...
                        return (
                            <Col key={idx}>
                                    <Card className={styles.card}>
                                        <center>
                                    <div className={styles.square} style={{ height: d.height * 7, width: d.width * 7 }}>
            ...
            <Row>
                        ...
                        {devices.map(function (d, idx) {
                            return (      
                                <ListGroup.Item key={idx}>
                                    <InputGroup className="mb-3">
                                    <InputGroup.Text>{d.deviceName} <Badge bg="primary">{d.quantity}</Badge></InputGroup.Text>
                ...
                <h3>Layout</h3>
                    <div className={styles.land}>
                        {cart.map((d: Device, idX) => (
                            <div key={idX} className={styles.square} style={{ height: d.height * 6, width: d.width * 6 }}>
                                <p>{d.deviceName}</p>
                            </div>
                        ))}
                        {transfor.map((d: Device, idX) => (
                            <div key={idX} className={styles.square} style={{ height: d.height * 6, width: d.width * 6 }}>
                                <p>{d.deviceName}</p>
                            </div>
                        ))}
